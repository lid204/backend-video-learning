...
// Kết nối với Aiven MySQL Online (Có SSL và Port)
const pool = mysql.createPool({
  ...
  ssl: {
    rejectUnauthorized: false // Bắt buộc khi dùng Database Online
  }
});

// Kiểm tra kết nối và TỰ ĐỘNG TẠO BẢNG nếu chưa có
pool.getConnection()
  .then(async (connection) => {
    ...
    `);
    console.log("✅ Bảng users đã sẵn sàng trên mạng!");
    connection.release();
  })
